    ...
    item_posts = [
        {
            ...
            available: true, release_time: random_past_time, expire_time: future_time,
        },
        {
        ...
        },
        {
            ...
            available: false, release_time: random_past_time, expire_time: future_time,
        },
        {
            title: "Old guitar, used for %d years" % user.id, category: "item", subcategory: "music related", price: 233.3,
            available: true, release_time: random_past_time, expire_time: random_past_time,
        },
        {
